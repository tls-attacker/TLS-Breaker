...
import de.rub.nds.tlsbreaker.heartbleed.config.BleichenbacherCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.Cve20162107CommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.EarlyCCSCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.EarlyFinishedCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.GeneralDrownCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.HeartbleedCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.InvalidCurveAttackConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.Lucky13CommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.PaddingOracleCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.PoodleCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.PskBruteForcerAttackClientCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.PskBruteForcerAttackServerCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.SimpleMitmProxyCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.SpecialDrownCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.TLSPoodleCommandConfig;
import de.rub.nds.tlsbreaker.heartbleed.config.delegate.GeneralAttackDelegate;
import de.rub.nds.tlsbreaker.heartbleed.impl.Attacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.BleichenbacherAttacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.Cve20162107Attacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.EarlyCCSAttacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.EarlyFinishedAttacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.HeartbleedAttacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.InvalidCurveAttacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.Lucky13Attacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.PaddingOracleAttacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.PoodleAttacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.PskBruteForcerAttackClient;
import de.rub.nds.tlsbreaker.heartbleed.impl.PskBruteForcerAttackServer;
import de.rub.nds.tlsbreaker.heartbleed.impl.SimpleMitmProxy;
import de.rub.nds.tlsbreaker.heartbleed.impl.TLSPoodleAttacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.drown.GeneralDrownAttacker;
import de.rub.nds.tlsbreaker.heartbleed.impl.drown.SpecialDrownAttacker;
