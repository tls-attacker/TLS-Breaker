...
public class InvalidCurvePoint {
        ...
        switch (group) {
            case SECP160K1:
                return new InvalidCurvePoint(
                        new BigInteger("6F6118AE7199611C0B4F95CFE3B7DEDA68301E69", 16),
                        new BigInteger("F6F9D0E04364C716C25263D7E44CA6C571D22597", 16),
                        new BigInteger("5"),
                        NamedGroup.SECP160K1);
            case SECP160R1:
                return new InvalidCurvePoint(
                        new BigInteger("D465C0476AE02C499B0561B9C752C5CFEE8501ED", 16),
                        new BigInteger("5B6394C2C94D9214417E722792D0C07617CC31A6", 16),
                        new BigInteger("5"),
                        NamedGroup.SECP160R1);
            case SECP160R2:
                return new InvalidCurvePoint(
                        new BigInteger("2790AABFE83C792584D45D5259ECCA28843D56AA", 16),
                        new BigInteger("5DE5B6B1EC7BDA3940ABA6AD9AE01008040D5949", 16),
                        new BigInteger("5"),
            ...
            case SECP224K1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "54510A6A85EF6144CA057E159DD83C240E3A69B06EE2CAC06BD25AC7", 16),
                        new BigInteger(
                                "D2799F20E14C33AB704203F75EBDB38471919531970090DE8D12BC95", 16),
                        new BigInteger("7"),
                        NamedGroup.SECP224K1);
            case SECP224R1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "A02F6D2FEBD6C53F11737C43EDDAF9A5026A21245DACA9342CFF7247", 16),
                        new BigInteger(
                                "3B0781466C19DCCCAD13A2591A4DFAB7DADF210E9A150CE0C00137D9", 16),
                        new BigInteger("5"),
                        NamedGroup.SECP224R1);
            case SECP256K1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "5748979A06D28004D165F01FCA69C80DECAFB0119BA2A7C4C7F84C7AF2DCA311",
                                16),
                        new BigInteger(
                                "D9625DF3DC92015DEB22AC7242ABEBE512B195E973BA657203F1BDEE8662B45A",
                                16),
                        new BigInteger("7"),
            ...
            case SECP256R1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "21D2EFDDCFDF5C96268A16A8D5B8CB49EAD2DDE206259FE98686188A30CF0339",
                                16),
                        new BigInteger(
                                "D440D09110D30D6CC3CDBBC38284109DB3ACA31F3C6717E29F1CE9D4088D4B1C",
                                16),
                        new BigInteger("5"),
            ...
            case BRAINPOOLP256R1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                ...
                                16),
                        new BigInteger(
                                "24392E4B249529608415683ABF8DF8017A577A447B791233BFF1F8D50003C3DA",
                                16),
                        new BigInteger("5"),
    ...
    /**
     * Provides an Invalid Curve point with an order that is greater than the order of the point
    ...
    public static InvalidCurvePoint alternativeOrder(NamedGroup group) {
        switch (group) {
            case SECP160K1:
                return new InvalidCurvePoint(
                        new BigInteger("1D87BDF3020ECF141B9CCF6CD469670E8391E2C4", 16),
                        new BigInteger("1311274F63434234956CE364DDDAEA82B8656A92", 16),
                        new BigInteger("7"),
                        NamedGroup.SECP160K1);
            case SECP160R1:
                return new InvalidCurvePoint(
                        new BigInteger("2D7A466ED80D9047E8C6D31A53BD96096A57C9A", 16),
                        new BigInteger("8931F5FE3B75A76D77B084D4B9C5AE41F94C55A7", 16),
                        new BigInteger("7"),
                        NamedGroup.SECP160R1);
            case SECP160R2:
                return new InvalidCurvePoint(
                        new BigInteger("7659726CAB152DA1499B6D440F7C59D375765748", 16),
                        new BigInteger("ED4D6EFAEACD74C884D56C8E67CE9219CE9799F2", 16),
                        new BigInteger("7"),
                        NamedGroup.SECP160R2);
            case SECP192K1:
                return new InvalidCurvePoint(
                        new BigInteger("B6CF1A71A6B0DB9B14A54C76D9B31DC0C62046DF3179A165", 16),
                        new BigInteger("A057F8CFDB0D0C84A2A6951877F6D0C764920133CB1121E9", 16),
                        new BigInteger("13"),
                        NamedGroup.SECP192K1);
            case SECP192R1:
                return new InvalidCurvePoint(
                        new BigInteger("222C329BB757B627EFDB51830F1DD74EB357C2319B84EFA6", 16),
                        new BigInteger("5EDF6B98415FB433C0A2B8870E0ACFF8F29261D97E150C05", 16),
                        new BigInteger("7"),
                        NamedGroup.SECP192R1);
            case SECP224K1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "504AF25E468A1DDFBD173146859AD3B33508452D5059CF6EAC45EA42", 16),
                        new BigInteger(
                                "C43A7D1FB2D009A17F16565D209C9FB4A7D1E76B0AF29A3BD89BC331", 16),
                        new BigInteger("31"),
                        NamedGroup.SECP224K1);
            case SECP224R1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "338C727BDD4CC6E62302852D16E4B53902BC9A60625933FDC7B8D0E", 16),
                        new BigInteger(
                                "1729BFAD9B19FAC33F6F4EFCD02BCE0C37E268EF3E308D2E48773D51", 16),
                        new BigInteger("7"),
                        NamedGroup.SECP224R1);
            case SECP256K1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "D39131C3845D27BD25896B1C5A44579131BD7F0FB888DC7CFF27F9E868F05D20",
                                16),
                        new BigInteger(
                                "73D4222014F2D8D30D9D8495CC7B1CFA4969977F90C304C781C62D260C04E5ED",
                                16),
                        new BigInteger("13"),
                        NamedGroup.SECP256K1);
            case SECP256R1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "55E964D6B59EAB7398F5FD916DA422A22532F38174DD16AD4124909EBD40C2AD",
                                16),
                        new BigInteger(
                                "9DD16682A1DB35B97E699967D2883A6943EB67C2F9EDF54D7C3CD6ACFEE532CD",
                                16),
                        new BigInteger("7"),
                        NamedGroup.SECP256R1);
            case SECP384R1:
            ...
            case BRAINPOOLP256R1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                ...
                                16),
                        new BigInteger(
                                "7F2F16CF0689CDDF098C79201185AF9A1787F94B954C0CA3063B3ECAA4BFF57D",
                                16),
                        new BigInteger("7"),
                        NamedGroup.BRAINPOOLP256R1);
            case BRAINPOOLP384R1:
    ...
    /**
     * Provides an Invalid Curve point with an order that is far greater than the order of the point
    ...
    public static InvalidCurvePoint largeOrder(NamedGroup group) {
        switch (group) {
            case SECP160K1:
                return new InvalidCurvePoint(
                        new BigInteger("4D7CFB5017AB4A1A3961246D26CB12B908BDDD9C", 16),
                        new BigInteger("794884B1B0FDE7DC6F2F82AFE4353933318CD524", 16),
                        new BigInteger("759948073135831273703554930117"),
                        NamedGroup.SECP160K1);
            case SECP160R1:
                return new InvalidCurvePoint(
                        new BigInteger("9FDE9461895EF138EE21D3C94238A5A2B745E2DA", 16),
                        new BigInteger("5D36BA39DC089A43DA60ACF9FAB4F8C0A39D4C3", 16),
                        new BigInteger("4191613672177535554053499360049"),
                        NamedGroup.SECP160R1);
            case SECP160R2:
                return new InvalidCurvePoint(
                        new BigInteger("B3F4B6E3D06FF19098F49263E8D7FC34672E18B9", 16),
                        new BigInteger("2475E9826AEE03775E9B938D2F50A1B616D2402F", 16),
                        new BigInteger("27775205518255473578517839"),
                        NamedGroup.SECP160R2);
            case SECP192K1:
                return new InvalidCurvePoint(
                        new BigInteger("F734BE0E63B102ED74D5DB28285AC7E7BC70EBA1B53270AE", 16),
                        new BigInteger("81CF4C441806F65DCD966B349984089E5001E8E2BCAE8C1", 16),
                        new BigInteger("60231627103175743"),
                        NamedGroup.SECP192K1);
            case SECP192R1:
                return new InvalidCurvePoint(
                        new BigInteger("625CCE1305788A185AA2486C50CA37A7C229FBDEAE6DE41C", 16),
                        new BigInteger("5EF2D35652D26A0505B13E4D5A833AA8E9623D116752334E", 16),
                        new BigInteger("46532316352815299146823531531060011"),
                        NamedGroup.SECP192R1);
            case SECP224K1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "DA762C8EFD666A6ECD7B67F7AAA9ED0D641A4C376BA0E5E4CED62B9C", 16),
                        new BigInteger(
                                "4D9274FF2316656B06945AD4E1F227A6850BB6E6157FC7853704E5F1", 16),
                        new BigInteger("124289311"),
                        NamedGroup.SECP224K1);
            case SECP224R1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "75D3194E237B0F3927FB15420FFAA34752F27C599A7E4A99799C262F", 16),
                        new BigInteger(
                                "AA962E5A2DEC7090FBCA62C637EF23E5E940283535D90193CA57B1A", 16),
                        new BigInteger("96297495373"),
                        NamedGroup.SECP224R1);
            case SECP256K1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "3DC31FF57D07714E0CBD27549E123897065F40D030398A02308E6BDB3A83F898",
                                16),
                        new BigInteger(
                                "E312B9436F6E23676A8FCBCE0CE4283F39395AD5A6FD15E9446F1B29A9BC9C71",
                                16),
                        new BigInteger("22921299619447"),
                        NamedGroup.SECP256K1);
            case SECP256R1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                "6BACBD65749F99750E1BE0A2E94766BE0C59C173B7DE6BF2721726D17A4B22D5",
                                16),
                        new BigInteger(
                                "8578AF52DA5BD23DA9E99A82E4D5F059B1A4AB1E9516F34858908D032EFB282E",
                                16),
                        new BigInteger("24859202477"),
                        NamedGroup.SECP256R1);
            case SECP384R1:
                return new InvalidCurvePoint(
                        new BigInteger(
            ...
            case BRAINPOOLP256R1:
                return new InvalidCurvePoint(
                        new BigInteger(
                                ...
                                16),
                        new BigInteger(
                                "A84D6A486D63750D6BBFEECD5D216EBBD27356C05A1FA93E91A23C6CBEB336D",
                                16),
            ...
            case BRAINPOOLP512R1:
                return new InvalidCurvePoint(
                        ...
                        new BigInteger(
                                ...
                                16),
                        new BigInteger("3757915019513500970791"),
                        NamedGroup.BRAINPOOLP512R1);
            default:
                return null;
        }
