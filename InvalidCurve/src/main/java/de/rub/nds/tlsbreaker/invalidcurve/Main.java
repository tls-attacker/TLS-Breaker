...
import de.rub.nds.tlsbreaker.invalidcurve.config.BleichenbacherCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.Cve20162107CommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.EarlyCCSCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.EarlyFinishedCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.GeneralDrownCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.HeartbleedCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.InvalidCurveAttackConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.Lucky13CommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.PaddingOracleCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.PoodleCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.PskBruteForcerAttackClientCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.PskBruteForcerAttackServerCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.SimpleMitmProxyCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.SpecialDrownCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.TLSPoodleCommandConfig;
import de.rub.nds.tlsbreaker.invalidcurve.config.delegate.GeneralAttackDelegate;
import de.rub.nds.tlsbreaker.invalidcurve.impl.Attacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.BleichenbacherAttacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.Cve20162107Attacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.EarlyCCSAttacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.EarlyFinishedAttacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.HeartbleedAttacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.InvalidCurveAttacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.Lucky13Attacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.PaddingOracleAttacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.PoodleAttacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.PskBruteForcerAttackClient;
import de.rub.nds.tlsbreaker.invalidcurve.impl.PskBruteForcerAttackServer;
import de.rub.nds.tlsbreaker.invalidcurve.impl.SimpleMitmProxy;
import de.rub.nds.tlsbreaker.invalidcurve.impl.TLSPoodleAttacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.drown.GeneralDrownAttacker;
import de.rub.nds.tlsbreaker.invalidcurve.impl.drown.SpecialDrownAttacker;
