...
public class TwistedCurvePoint {
    ...
    /**
     * An appropriate coordinate used to fill bytes when no compression is used The attack does not
     * require an Y-coordinate as we are targeting X-only ladders To save computations, this
     * coordinate is the y-coordinate of the point obtained from the transformed twisted curve
     */
    ...
    private TwistedCurvePoint(
            BigInteger publicPointBaseX,
            BigInteger publicPointBaseY,
            BigInteger order,
            NamedGroup intendedNamedGroup,
            BigInteger d) {
        ...
        switch (group) {
            case SECP160K1:
                return new TwistedCurvePoint(
                        new BigInteger("CAA163F84C55E308840926EB7347951F5BBB937B", 16),
                        new BigInteger("804BC5BCB00D3C0A47571FFCC9275755F506680C", 16),
                        new BigInteger("7"),
                        NamedGroup.SECP160K1,
                        new BigInteger("C59136F5F837CEEE4C4071B911125BF127E89260", 16));
            case SECP160R1:
                return new TwistedCurvePoint(
            ...
            case SECP160R2:
                return new TwistedCurvePoint(
                        new BigInteger("B1A722C8E8C916E4B63562C0429B36491187756", 16),
                        new BigInteger("E9DDA1D11EB136D574EAAFB70281E902E696F0", 16),
                        new BigInteger("163"),
                        NamedGroup.SECP160R2,
                        new BigInteger("3444EB0B52787F04B7807B26D57249F0FBBF597", 16));
            case SECP192K1:
                return new TwistedCurvePoint(
            ...
            case SECP224K1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "332C4168D13C82495CD5216012EAF9B2A6FF73EB80DBE470BAB28D32", 16),
                        new BigInteger(
                                "21A117E36A4D8C047BAD31C5EDF8B4BF8308968DFFAF2425C33B5AE2", 16),
                        new BigInteger("2161"),
                        NamedGroup.SECP224K1,
                        new BigInteger(
                                "73DDCEEA75D52BA94BB278BF4D339D40F467F6451EF26756A51E1F3", 16));
            case SECP224R1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "CAE5F9CCFA939BA4DA1B171660E4E6225AFECBC54CB5A07670EF4FB7", 16),
                        new BigInteger(
                                "AEB87151E7A3370301B7C984E52DFDB45AE6CF800143A50C4F2750EE", 16),
                        new BigInteger("11"),
                        NamedGroup.SECP224R1,
                        new BigInteger(
                                "F517A55DD490FCD53A83392176BB9B1C6DD4E2F5EFDEE2F6454367BB", 16));
            case SECP256K1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "4B11C45CC1BB2C2F82DB5D12C7814ABD58C342FCBDA0040E9303A3A65B6DBA66",
                                16),
                        new BigInteger(
                                "8FFE225FAD43C14B63ABC2CD14A20EC87AC83CA3E1DFD7FAD1FB92F7BACFD544",
                                16),
                        new BigInteger("13"),
                        NamedGroup.SECP256K1,
                        new BigInteger(
                                "7DC1351D8B1CB791B70411399271F823ED3AB9F54E52F591A5D4273D9F209570",
                                16));
            case SECP256R1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "18F9BAE7747CD844E98525B7CCD0DAF6E1D20A818B2175A9A91E4EAE5343BC98",
                                16),
                        new BigInteger(
                                "6212FB55CD57E1843CCBD1990DDA297E1C97DF1AED8B0DEE84F0EE33B5766859",
                                16),
                        new BigInteger("5"),
            ...
            case BRAINPOOLP256R1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                ...
                                16),
                        new BigInteger(
                                "17BDECE85FF8A6475A9B3D23867F8E0D1860E7F02B7BE21A02EA4E715E685B6",
                                16),
                        new BigInteger("5"),
    ...
    /**
     * Provides a Twisted Curve point with an order that is greater than the order of the point
     * returned by smallOrder(group).
     *
     * @param group
     * @return TwistedCurvePoint
     */
    public static TwistedCurvePoint alternativeOrder(NamedGroup group) {
        switch (group) {
            case SECP160K1:
                return new TwistedCurvePoint(
                        new BigInteger("9C84267D3E6407C5964E752D0CE7A6B7DD9AE110", 16),
                        new BigInteger("4D169E9BB555AC7F719591EC0A90164C6401206A", 16),
                        new BigInteger("13"),
                        NamedGroup.SECP160K1,
                        new BigInteger("9E8D3199FD3570027A6E1D0850E06EBFCE756F86", 16));
            case SECP160R1:
                return new TwistedCurvePoint(
                        new BigInteger("F4184DA39ACF4D188776C4F158E7F89FB4CA9855", 16),
                        new BigInteger("3E2C39B04BDD5B2ED6EF918B047A8BA19CEBD391", 16),
                        new BigInteger("11855018473"),
                        NamedGroup.SECP160R1,
                        new BigInteger("ED06DE9D4832262BE18A969994749C75E5BD5039", 16));
            case SECP160R2:
                return new TwistedCurvePoint(
                        new BigInteger("D3A76A4198988A7A2B57CDD078A3516DEEA62E84", 16),
                        new BigInteger("D580D394BC089E85195952EC88898BCFF3A1F5BC", 16),
                        new BigInteger("457"),
                        NamedGroup.SECP160R2,
                        new BigInteger("ADA194B09D98F37CD19AB395364AD759E9308FC1", 16));
            case SECP192K1:
                return new TwistedCurvePoint(
                        new BigInteger("7AB9A222542FAC7568B77F46C380D406208FDC8307E1136C", 16),
                        new BigInteger("E327060D092CB38C607B2138EE3965D5462DEA1C1DCD413E", 16),
                        new BigInteger("56383"),
                        NamedGroup.SECP192K1,
                        new BigInteger("6EE349745C5A6698FCA8C84071DEF196C9C0E63CB841E10C", 16));
            case SECP192R1:
                return new TwistedCurvePoint(
                        new BigInteger("F4DBC8267E3397902590C080EAD3505F71C5EF26E77139FE", 16),
                        new BigInteger("E60132AA3824F2F2EE02DBB82B9902BB0B7161209376CA14", 16),
                        new BigInteger("10864375060560251605900677743"),
                        NamedGroup.SECP192R1,
                        new BigInteger("BD20F6E0768CC832AC7D64308876260BC4E8D50E7F0B39CA", 16));
            case SECP224K1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "B5472F4F7846F6B6ADA8D07FE95B277DC68B413AFBE2B4336D62424D", 16),
                        new BigInteger(
                                "4FDEBFC2CDC9EB2B7C7861D0D84A2923C6A659C46CA8EF2EA64C3844", 16),
                        new BigInteger("74128698849747076047230957053"),
                        NamedGroup.SECP224K1,
                        new BigInteger(
                                "6A77E4ED900DEBDD68B6417C9B9CE9DD29492554E8B3A13A32DDE1EF", 16));
            case SECP224R1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "AA145DD90EB7F9A69B90F371BD20FD5CCCE1F476E1226BFD836F74E5", 16),
                        new BigInteger(
                                "784131970975B6464221AC6E020419918416BE2B4E9D99A740258E9D", 16),
                        new BigInteger("47"),
                        NamedGroup.SECP224R1,
                        new BigInteger(
                                "180952C95466BA54FED99E93AD1AC36CB45C9AF3DB6AB54910556022", 16));
            case SECP256K1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "55BC3A2DF867DF94946938FE89EF88412E375895FC37E3A10583EDFCE02BBA68",
                                16),
                        new BigInteger(
                                "8E8218F976D61730B6AB7C1926875C7CEA6B60A4FDAD0A10F021B52D99C51C2D",
                                16),
                        new BigInteger("3319"),
                        NamedGroup.SECP256K1,
                        new BigInteger(
                                "41E67D8ACDC8D180263A66C7CCE6D99AD57A2F484D8CE49663EFADEC15EB7179",
                                16));
            case SECP256R1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "C8919F855F87325D8357A5AECD199F2D293A4E3DA6EFB08B06FC4DF50A287489",
                                16),
                        new BigInteger(
                                "46E408F396BB2381C8B8CD19857BC52ADEDE93E523C25855666C1E820DEB7BAD",
                                16),
                        new BigInteger("13"),
                        NamedGroup.SECP256R1,
                        new BigInteger(
            ...
            case BRAINPOOLP256R1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                ...
                                16),
                        new BigInteger(
                                "A7222E3B35D69F71EE5E9F036E3339D3A4124D0CD0E4E63DD6B89969E6A3A4F9",
                                16),
    ...
    /**
     * Provides a Twisted Curve point with an order that is far greater than the order of the point
     * returned by smallOrder(group) and alternativeOrder(group).
     *
     * @param group
     * @return TwistedCurvePoint
     */
    public static TwistedCurvePoint largeOrder(NamedGroup group) {
        switch (group) {
            case SECP160K1:
                return new TwistedCurvePoint(
                        new BigInteger("5FCCCA5A8159FC7F96160B0A6A18C763FDAAA6F4", 16),
                        new BigInteger("17F6FB729D1BB98DBCC99E477B3A346D04C15566", 16),
                        new BigInteger("153607"),
                        NamedGroup.SECP160K1,
                        new BigInteger("860B7D478DDEE3FD227A1DE4354BACE63135D75D", 16));
            case SECP160R1:
                return new TwistedCurvePoint(
                        new BigInteger("19C789A1587E2220B009EA258CA14B10DA4AC2EF", 16),
                        new BigInteger("6C2A6FDD88D6E8CA81DA80BED98BDD2A624C084B", 16),
                        new BigInteger("235719430040354028377973833190775523"),
                        NamedGroup.SECP160R1,
                        new BigInteger("11939C1A0932877A46167E64D5BD655C0CE5CB0D", 16));
            case SECP160R2:
                return new TwistedCurvePoint(
                        new BigInteger("44DBA585B7AB04AD0FC223A7C96A2A6074E7427F", 16),
                        new BigInteger("9F5F7CF0A17BD1E77B673130963D0DE667D74F0D", 16),
                        new BigInteger("11899113760119541370164111066275852599"),
                        NamedGroup.SECP160R2,
                        new BigInteger("4D610505F8BE3D6E47AB2F7B5D0BB2FE342CBE16", 16));
            case SECP192K1:
                return new TwistedCurvePoint(
                        new BigInteger("BE403BE1E072BD43284DD8E6FA0ED4E71D1D7D66D8EEE872", 16),
                        new BigInteger("8E48191C5BB1B183B7F368D5BE2DF06C5AF78E6901A60545", 16),
                        new BigInteger("619124299"),
                        NamedGroup.SECP192K1,
                        new BigInteger("463973CB009D48867D731EF7DE5AD982A80BE4D7CD4C2F85", 16));
            case SECP192R1:
                return new TwistedCurvePoint(
                        new BigInteger("23D188A0920E8F8F08506CD694681CD00A241F12DE790C68", 16),
                        new BigInteger("A0E0E6235E8C93ED947252D9C0BF3EA241A0664E3443FE2D", 16),
                        new BigInteger("25120401793443689936479125511"),
                        NamedGroup.SECP192R1,
                        new BigInteger("EAED9F5D9877E70995534E5ECF03ABEECC02C987F24D3D23", 16));
            case SECP224K1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "E3D3A1F439C39C7B5F950740F3873DCF9735C02B2114ECF1AF687BB5", 16),
                        new BigInteger(
                                "2356DDEE0A542911389B6E09BF5574ABE8FF14F2E4DB051C995A25E5", 16),
                        new BigInteger("2077747965710347701281853075092809"),
                        NamedGroup.SECP224K1,
                        new BigInteger(
                                "DA7748B4AB209DB506C839D37BBDE023C83385FC16B0D6AD520FCC92", 16));
            case SECP224R1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "8FDC83E56BC637374BA93E363D09CA11E228435223A346C0ECDFCEA8", 16),
                        new BigInteger(
                                "B14F991B3EDD7B7DA60B3C739687BD2A96018538FF42A1E939387CD1", 16),
                        new BigInteger("3015283"),
                        NamedGroup.SECP224R1,
                        new BigInteger(
                                "E8A543E7CC4318862406F1BA068E2929934EEFCA7D2CD33EDA286D67", 16));
            case SECP256K1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "2217E13B7FA935A7A1ABD7CB74E21CD77D7956379786743AE4FD5569503AD8A6",
                                16),
                        new BigInteger(
                                "DA50FF90EC393E547E7C5013441EF838124D19D1DCF5A3983246C6ECA06F543C",
                                16),
                        new BigInteger(
                                "1013176677300131846900870239606035638738100997248092069256697437031"),
                        NamedGroup.SECP256K1,
                        new BigInteger(
                                "5263ECBFDD26F11D2958AF74D50FB0C856AC612DE47A99C87F31F445F3775180",
                                16));
            case SECP256R1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                "A4251D059758E1046D2DD8114F5AD505B718F0455269D747642706E452031CED",
                                16),
                        new BigInteger(
                                "CFE3435B96F62C2365126C1F639F04C8F1C79C470D6887F540FCEACB2B75725",
                                16),
                        new BigInteger(
            ...
            case BRAINPOOLP256R1:
                return new TwistedCurvePoint(
                        new BigInteger(
                                ...
                                16),
                        new BigInteger(
                                "1CCD6EB649E0246A4B4E5A673DCC8729ED383FAC14C2E998D00191CF325D1935",
                                16),
                        new BigInteger("492167257"),
                        NamedGroup.BRAINPOOLP256R1,
                        new BigInteger(
            ...
            case BRAINPOOLP384R1:
                return new TwistedCurvePoint(
                        ...
                        new BigInteger(
                                ...
                                16),
                        new BigInteger("125972502705620325124785968921221517"),
                        NamedGroup.BRAINPOOLP384R1,
                        new BigInteger(
