...
public class InvalidCurveServerSelection extends ServerSelection {

    public InvalidCurveServerSelection(List<PcapSession> sessions) {
        super(sessions);
    }
    ...
    protected List<PcapSession> filterServers(List<PcapSession> sessions) {
        ...
        for (PcapSession s : sessions) {
            ...
            if (selectedCipher.name().contains("TLS_ECDH_")) {
