...
public class PcapAnalyzerTest {
    ...
    public static Stream<Arguments> providePremasterSecretExtractionTestVectors() {
        return Stream.of(
                ...
                Arguments.of(
                        "2nd_TLS_RSA_WITH_ARIA.pcapng",
                        List.of(
                                ArrayConverter.hexStringToByteArray(
                                        ""))),
                Arguments.of(
                        "TLS_ECDH_RSA_WITH_NULL_SHA.pcapng",
                        List.of(
                                ArrayConverter.hexStringToByteArray(
                ...
                Arguments.of(
                        ...
                        List.of(
                                ...
                                ArrayConverter.hexStringToByteArray(
                                        ""))),
                Arguments.of(
                        "TLS_RSA_WITH_AES_128_CCM_8.pcapng",
                        List.of(
                                ArrayConverter.hexStringToByteArray(
    ...
    public void testExtractEncryptedPremasterSecret(
            String providedPcapFile, List<byte[]> expectedPmsValues) {
        PcapAnalyzer sample =
                new PcapAnalyzer(
                        String.format("src/test/resources/pcap_files/%s", providedPcapFile));
        ...
        for (int i = 0; i < expectedPmsValues.size(); i++) {
            ...
            assertArrayEquals(
                    expectedPmsValues.get(i),
                    pms,
                    "Mismatch in expected premaster secret with id " + i);
        }
    }
    ...
    public void testExtractSessionsSlow() {
        ...
        assertTrue(
                ...
                "Error in reading correct number of sessions");
    }
}
