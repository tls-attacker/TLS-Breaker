...
public enum CcaCertificateType {
    ...
    ROOTv3_CAv3_LEAF_RSAv3_MismatchingAlgorithmParameters(
            ...
            false,
            true),
    ROOTv3_CAv3_LEAF_RSAv3_MismatchingAlgorithms1(
            "RSA Leaf certificate generated based on the provided "
    ...
    ROOTv3_CAv3_LEAF_RSAv3_MismatchingAlgorithms2(
            "Same as ROOTv3_CAv3_LEAF_RSAv3_MismatchingAlgorithms1 "
    ...
    CcaCertificateType(
            String description, Boolean requiresCertificate, Boolean requiresCaCertAndKeys) {
