...
/**
 * An IncrementingGuessProvider is a GuessProvider which tries all byte[] sequences in a growing
 * order. Starting by an empty byte[] and then continuing the sequence with th byte[] size increased
 * by 1. It would then try 00, 01, 02, ..., FF and continue with 00 00, 00 01, 00 02 , ... to FF, FF
 * and so on.
 */
