...
public class PaddingOracleCommandConfig extends AttackConfig {
    ...
    @Parameter(names = { "-recordEngine", "-record_engine" }, description = "The record generator used for the PaddingOracle")
    private PaddingRecordGeneratorType recordGeneratorType = PaddingRecordGeneratorType.SHORT;

    @Parameter(names = { "-vectorEngine", "-vector_engine" }, description = "The vector generator used for the PaddingOracle")
